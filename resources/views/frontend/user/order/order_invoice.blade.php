...
<h3>Products</h3>
    ...
    <tbody>
     ...
     @foreach($orderItem as $item)
      <tr class="font">
        ...
        <td align="center">RM{{ $item->price }}</td>
        <td align="center">RM{{ $item->price * $item->qty }} </td>
      </tr>
      @endforeach
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span>RM{{ $order->amount }}</h2>
            <h2><span style="color: green;">Total:</span> RM{{ $order->amount }}</h2>
