...
<div class="body-content">
	...
	<h1>@if(session()->get('language') == 'malay') {{ $blogpost->post_title_my }} @else {{ $blogpost->post_title_en }} @endif</h1>
 ...
 <!-- Go to www.addthis.com/dashboard to customize your tools -->
	...
	<p> @if(session()->get('language') == 'malay') {!!  $blogpost->post_details_my  !!} @else {!!  $blogpost->post_details_en  !!} @endif
	</p>
