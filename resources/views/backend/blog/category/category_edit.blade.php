...
<!--   ------------ Add Blog Category Page -------- -->
 ...
 <form method="post" action="{{ route('blogcategory.update') }}" >
	 ...
	 <div class="form-group">
		<h5>Blog Category (EN)  <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Blog Category (MY) <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text" name="blog_category_name_my" class="form-control" value="{{ $blogcategory->blog_category_name_my }}"  >
