...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  ...
  <form method="post" action="{{ route('product-update') }}" >
            ...
            <input type="hidden" name="admin_id" value="{{ $prodAdmin->id }}">
					  <div class="row">
	<div class="col-12">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags_my" class="form-control" value="{{ $products->product_tags_my }}" data-role="tagsinput" required="">
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_size_my" class="form-control" value="{{ $products->product_size_my }}" data-role="tagsinput"  >
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_my" class="form-control" value="{{ $products->product_color_my }}" data-role="tagsinput" required="">
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_my" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_my !!}
	</textarea>
	 		 </div>
		</div>
