	...
	<div class="controls">
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Name (MY) <span class="text-danger">*</span></h5>
			<div class="controls">
				<input type="text" name="product_name_my" class="form-control" required="">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			<h5>Product Tags (MY) <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_tags_my" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Size (MY) <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_size_my" class="form-control" value="Small,Midium,Large" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Color (MY)<span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_color_my" class="form-control" value="red,Black,Large" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 7th row  -->
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
	     ...
	     <div class="form-group">
			<h5>Short Description (MY) <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea name="short_descp_my" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		Long Description (EN)
	     ...
	     <div class="form-group">
			<h5>Long Description (MY) <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="long_descp_my" rows="10" cols="80">
		Long Description (MY)
						</textarea>
	 		 </div>
		</div>
