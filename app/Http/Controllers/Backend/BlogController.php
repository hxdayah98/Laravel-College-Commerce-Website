...
class BlogController extends Controller
{
  ...
  public function BlogCategoryStore(Request $request){
       ...
       $request->validate([
    		...
    		'blog_category_name_en.required' => 'Input Blog Category (EN)',
    		'blog_category_name_my.required' => 'Input Blog Category (MY)',
    	]);
...
public function BlogCategoryUpdate(Request $request){
  ...
  public function BlogPostStore(Request $request){
  	...
  	$request->validate([
    		...
    		'post_title_en.required' => 'Input Post Title (EN)',
    		'post_title_my.required' => 'Input Post Title (MY)',
    	]);
	...
	BlogPost::insert([
		...
		'post_slug_my' => str_replace(' ', '-',$request->post_title_my),
		'post_image' => $save_url,
